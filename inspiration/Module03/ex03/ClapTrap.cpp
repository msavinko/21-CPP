...
ClapTrap::ClapTrap( void ) {
	std::cout << "Parent ClapTrap default constructor called" << std::endl;
...
ClapTrap::ClapTrap( const std::string & name ) {
	std::cout << "Parent ClapTrap constructor called" << std::endl;
	this->_name = name;
	this->_energyPoints = 10;
	this->_hitPoints = 10;
	this->_damagePoints = 0;
...
ClapTrap::~ClapTrap( void ) {
	std::cout << "Parent ClapTrap destructor called" << std::endl;
